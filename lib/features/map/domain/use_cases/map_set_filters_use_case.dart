...
interface class MapSetFiltersUseCase {
  final MapRepositoryInterface repo;

  MapSetFiltersUseCase(this.repo);
  TaskEither<Failure, Success<List<Water>>> call(List<Water> filters) {
    return repo.setFilters(filters);
  }
}
